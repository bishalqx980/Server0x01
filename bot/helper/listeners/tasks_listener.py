...
class MirrorLeechListener:
    ...
    async def onUploadComplete(self, link, size, files, folders, mime_type, name, rclonePath='', drive_id=None):
        ...
        botbuttons.ubutton('Check PM', f"https://t.me/{bot_name}", 'header')
        if self.isLeech:
            ...
            if not self.dmMessage:
                ...
                if not files:
                    ...
                    await sendMessage(self.message, gmsg + msg + msg_, botbuttons.build_menu(2))
                    if self.logMessage:
                        await sendMessage(self.logMessage, lmsg + msg)
                else:
                    fmsg = '\n'
            ...
            if link or rclonePath and config_dict['RCLONE_SERVE_URL']:
                ...
                if self.dmMessage:
                    ...
                    await sendMessage(self.message, lmsg + msg + _msg + msg_, botbuttons.build_menu(2))
                if self.logMessage:
