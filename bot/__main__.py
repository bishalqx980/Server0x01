...
async def stats(_, message):
    ...
    stats = f'<b><u>SYSTEM INFO</u></b>\n\n'\
            ...
            f'<b>• Disk space :</b><code> {get_readable_file_size(free)}</code>/<code>{get_readable_file_size(total)}</code>\n\n'\
...
async def main():
    ...
    await bot.send_message(chat_id=chat_id, text='<b>Bot Started !!</b>')
